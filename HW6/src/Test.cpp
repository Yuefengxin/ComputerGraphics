...
int main()
{
	...
	ShaderProgram shader3("ShaderPro/light.vs", "ShaderPro/light.fs");
	//ShaderProgram shader4("ShaderPro/light.vs", "ShaderPro/light.fs");
	ShaderProgram shader4("ShaderPro/phong.vs", "ShaderPro/phong.fs");
	//ShaderProgram shader5("ShaderPro/light.vs", "ShaderPro/light.fs");
	ShaderProgram shader5("ShaderPro/gouraud.vs", "ShaderPro/gouraud.fs");
	HW3 homework3(WIDTH, HEIGHT, shader1);
	HW4 homework4(WIDTH, HEIGHT, shader2);
	HW5 homework5(WIDTH, HEIGHT, shader2);
	HW6 homework6(WIDTH, HEIGHT, shader3, shader4, shader5);
